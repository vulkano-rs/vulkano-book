...
;hljs.registerLanguage("ini",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("bash",e)})();/*! `glsl` grammar compiled for Highlight.js 11.7.0 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `xml` grammar compiled for Highlight.js 11.7.0 */
